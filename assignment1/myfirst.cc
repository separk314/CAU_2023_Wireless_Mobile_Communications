...
main (int argc, char *argv[])
{
  ...
  // Install a point-to-point connection on the NetDeviceContainer
  ...
  address.SetBase ("10.1.1.8", "255.255.255.8");    // IP, subnet mask

  // IP assign(10.1.1.0+1, 10.1.1.0+2)
  Ipv4InterfaceContainer interfaces = address.Assign (devices);

  // Port: 9
  UdpEchoServerHelper echoServer (9);

  // nodes.Get(1): second node
